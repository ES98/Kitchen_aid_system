...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public void sendFile(String filename)
  {
    try
    {
      ...
      // send(filename);
      FileInputStream fin = new FileInputStream("/storage/emulated/0/Download/" + filename);
      byte[] buffer_send = new byte[128];
      int counter = 0;
      while((counter = fin.read(buffer_send, 0, buffer_send.length)) != -1)
      {
        pout.write(buffer_send, 0, counter);
        // System.out.println(buffer_send.length);
      }
  ...
  public void getFile(String filename)
  {
    ...
    try {
      ...
      fos = new FileOutputStream("/storage/emulated/0/Download/" + filename);
      ...
      while(true)
      {
        String breaker = new String(buffer, "UTF-8");
        if(breaker.contains("DONE"))
        {
